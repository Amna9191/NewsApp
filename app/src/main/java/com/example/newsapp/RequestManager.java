...
public class RequestManager {
    ...
    public void getNewsHeadlines(OnFetchDataListener listener, String sources, String query){
        CallNewsApi callNewsApi = retrofit.create(CallNewsApi.class);
        Call<NewsApiResponse> call = callNewsApi.callHeadlines(sources, query, context.getString(R.string.api_key));
